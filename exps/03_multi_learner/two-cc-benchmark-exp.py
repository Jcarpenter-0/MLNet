...
try:
    ...
    for pattern in validationPatterns:
        ...
        node.AddApplication(apps.Iperf3.PrepIperfCall(serverNode.IpAddress, serverNode.IpAddress, learner1.LearnerPort,
                                                      parallelTCPConnections=1, runDuration=10))
        node.AddApplication(apps.Iperf3.PrepIperfCall(serverNode.IpAddress, serverNode.IpAddress, iperfPort=9989,
                                                      learnerPort=learner2.LearnerPort, parallelTCPConnections=1,
                                                      runDuration=10))
