...
ax = graph1DF.plot(style=lineStrata, color=colorStrata, title='Multi-Agent - Reward', legend=False, figsize=(graphSize, graphSize))
ax.set_ylabel('Reward')
ax.set_xlabel('Number of Actions (per 10s)')
...
ax = graph1DF.plot(style=lineStrata, color=colorStrata, title='Multi-Agent - BPS', legend=False, figsize=(graphSize, graphSize))
ax.set_ylabel('Bps')
ax.set_xlabel('Number of Actions (per 10s)')
...
ax = graph3DF.plot(style=lineStrata, color=colorStrata, title='Multi-Agent - RTT', legend=False, figsize=(graphSize, graphSize))
ax.set_ylabel('RTT')
ax.set_xlabel('Number of Actions (per 10s)')
...
ax = graph4DF.plot(style=lineStrata, color=colorStrata, title='Multi-Agent - Retransmits', legend=False, figsize=(graphSize, graphSize))
