...
try:
    ...
    learner = learners.Learner('{}./learners/logging_only_manager/logging_only_manager.py'.format(DirOffset)
                    , training=2
                    , learnerDir='./tmp/mm-iperf3/'
                    , traceFilePostFix='pattern-{}-mm-iperf3'.format('vegas')
                    , miscArgs=['./vegas-pattern.csv'])
    ...
    learner = learners.Learner('{}./learners/logging_only_manager/logging_only_manager.py'.format(DirOffset)
                    , training=2
                    , learnerDir='./tmp/mn-iperf/'
                    , traceFilePostFix='pattern-mn-iperf-{}'.format('vegas')
                    , miscArgs=['./vegas-pattern.csv'])
    ...
    learner = learners.Learner('{}./learners/logging_only_manager/logging_only_manager.py'.format(DirOffset)
                    , training=2
                    , learnerDir='./tmp/mn-iperf3/'
                    , traceFilePostFix='pattern-mn-iperf3-{}'.format('vegas')
                    , miscArgs=['./vegas-pattern.csv'])
